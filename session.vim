...
badd +25 bower.json
badd +1 app/scripts/directives/mytableedit.js
badd +28 app/scripts/services/getresourcesfirebase.js
badd +99 app/styles/main.css
badd +0 app/scripts/directives/boostrap-dialog.js
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 68 - ((24 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
normal! 05|
tabedit app/scripts/controllers/series.js
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 60 - ((26 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
...
68
normal! 041|
tabedit app/scripts/directives/boostrap-dialog.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 2resize ' . ((&columns * 107 + 70) / 141)
exe '3resize ' . ((&lines * 10 + 24) / 48)
exe 'vert 3resize ' . ((&columns * 107 + 70) / 141)
argglobal
enew
file NERD_tree_3
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
